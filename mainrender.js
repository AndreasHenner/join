      ...
      <div id="addTaskUnderDiv" class="add-task">
        <div id="taskTitle" class="add-task-to-board-title">
           ...
           <h2 id="add-edit-task" class="add-task-h2-big">Add Task</h2>
            ...
            <h2>Due Date</h2>
               <input id="inputDate" required class="add-task-due-date-input cursor-pointer cursor-pointer" id="dueDate" type="date" max="9999" placeholder="-TT" onkeydown="return false">
            </div>
              <div class="add-task-due-date">
                 <h2>Category</h2>
